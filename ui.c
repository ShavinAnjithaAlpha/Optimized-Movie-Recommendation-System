...
void ratemovie(int uid){
	int movieid;
	double rating;
	FILE *fstream = fopen("/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/ratings_learn.csv","a");
...
void getmovies(int uid){
	...
	get_movie_names(movienames,"/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/movies.csv");
	get_movie_genres(moviegenres,"/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/movies_genres.csv");
