...
int findusers(){
    char *line, *record;
    char tmp[1024];
    FILE *fstream = fopen("/home/shavin/dev/scientific/Movie-Recommendation-System/Dataset/ratings_learn.csv","r");
    int j=0;
    int max = 0;
...
void recommender(int uid){
	...
	get_utility_matrix(utility_matrix,"/home/shavin/dev/scientific/Movie-Recommendation-System/Dataset/ratings_learn.csv",No_of_movies, No_of_users, uid);
	get_movie_names(movienames,"/home/shavin/dev/scientific/Movie-Recommendation-System/Dataset/movies.csv");
	get_movie_genres(moviegenres,"/home/shavin/dev/scientific/Movie-Recommendation-System/Dataset/movies_genres.csv");
