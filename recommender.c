...
int findusers(){
    char *line, *record;
    char tmp[1024];
    FILE *fstream = fopen("/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/ratings_learn.csv","r");
    int j=0;
    int max = 0;
...
void recommender(int uid){
	...
	get_utility_matrix(utility_matrix,"/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/ratings_learn.csv",No_of_movies, No_of_users, userid); //getting utility matrix which will contain ratings according to user id(row) and movie id(coloumn)
	get_movie_names(movienames,"/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/movies.csv"); //getting movie names according to movie id(index)
	get_movie_genres(moviegenres,"/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System/Dataset/movies_genres.csv"); //getting movie genres according to movie id(index)
	...
	new_user_movies(newuser,"/home/shavin/dev/scientific/Optimized-Movie-Recommendation-System//Dataset/ratings_learn.csv", userid);
